...
def on_connect(client, userdata, flags, rc):
    ...
    client.subscribe([("pt:j1/mt:evt/rt:dev/rn:zigbee/ad:1/sv:meter_elec/ad:1_1",0),("pt:j1/mt:evt/rt:app/rn:energy_guard/ad:1",0)])
...
client.connect('192.168.1.100', 1884, 300)
